...
ggplot(data = d.carril.VM, aes(y = n, x = nom)) +
  geom_bar(stat = "identity", position = "dodge", fill = 'lightgray', color = 'black') +
...
d.vel.IC.V <- summary(d.vel.fit.V)$coefficient[2] + summary(d.vel.fit.V)$coefficient[2] * c(-1.96, 1.96) * summary(d.vel.fit.V)$coefficient[4]
d.vel.IC.M <- summary(d.vel.fit.M)$coefficient[2] + summary(d.vel.fit.V)$coefficient[2] * c(-1.96, 1.96) * summary(d.vel.fit.M)$coefficient[4]
